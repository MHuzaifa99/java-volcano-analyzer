...
public class VolcanoAnalyzerTests {
    ...
    // "Changbaishan", "Quilotoa", "Kuwae", "Bardarbunga", "Huaynaputina", "Long
    // Island", "Tambora", "Krakatau", "Santa Maria", "Novarupta", "Pinatubo" };
    ...
    // correct Location");
    // assertEquals( expected.getCountry(), actual.getCountry(), "should have
    // correct Country");
