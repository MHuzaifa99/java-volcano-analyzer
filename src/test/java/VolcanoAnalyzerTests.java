...
public class VolcanoAnalyzerTests {
    ...
    public void loadVolcanoes() throws IOException, URISyntaxException {
        ...
        System.out.println(actual + "asdfsdf");
        // Assert
    ...
    //Setup
    String[] expected = { "Caldera", "Stratovolcano", "Complex volcano", "Shield volcano", 
    "Pyroclastic shield", "Volcanic field", "Lava dome", "Subglacial volcano", "Crater rows", "Tuff cone", "Fissure vent", "Pyroclastic cone",
    "Submarine volcano", "Lava cone", "Pumice cone", "Mud volcano", "Cinder cone", "Compound volcano", "Maar"};
    //Execute
